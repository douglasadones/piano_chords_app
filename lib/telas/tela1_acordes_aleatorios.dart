...
import 'tela2_acordes_aleatorios.dart';

class Tela1AcordesAleatorios extends StatefulWidget {
  const Tela1AcordesAleatorios({Key? key}) : super(key: key);

  @override
  State<Tela1AcordesAleatorios> createState() => _Tela1AcordesAleatoriosState();
}

class _Tela1AcordesAleatoriosState extends State<Tela1AcordesAleatorios> {
  @override
                ...
                onPressed: () {
                  setState(() {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Tela2AcordesAleatorios(),
                      ),
                    );
                  });
                },
